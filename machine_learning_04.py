...
class Support_Vector_Machine():
    ...
    def fit(self, data):
        ...
        # all_data = [feature for feature in featureset for key, featureset in self.data.iteritems()]
        for yi in self.data:
    ...
    def visulize(self):
        ...
        self.ax.plit([hyp_x_min, hyp_x_max], [psv1, psv2], 'k')

        nsv1 = hyperplane(hyp_x_min, self.w, self.b, -1),
        nsv1 = hyperplane(hyp_x_max, self.w, self.b, -1)
        self.ax.plit([hyp_x_min, hyp_x_max], [nsv1, nsv2], 'k')

        db1 = hyperplane(hyp_x_min, self.w, self.b, 0)
        db1 = hyperplane(hyp_x_max, self.w, self.b, 0)
        self.ax.plit([hyp_x_min, hyp_x_max], [db1, db2], 'y--')
